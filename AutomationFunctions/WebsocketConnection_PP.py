...
class CSVLogger:
    ...
    def log(self, spread_data):
        ...
        row = [
            ...
            spread_data['best_bid_price_okx'],
            spread_data['best_ask_price_okx'],
...
class SpreadCalculator:
    ...
    def calculate_spread_data(self):
        ...
        return {
            ...
            'best_bid_price_okx': perp1_best_bid,
            'best_ask_price_okx': perp1_best_ask,
            'best_bid_price_bybit': perp2_best_bid,
            'best_ask_price_bybit': perp2_best_ask,
            'impact_bid_price_okx': perp1_best_bid,
            'impact_ask_price_okx': perp1_best_ask,
            'impact_bid_price_bybit': perp2_best_bid,
            'impact_ask_price_bybit': perp2_best_ask,
            'okx_orderbook': perp1_data,
            'bybit_orderbook': perp2_data,
