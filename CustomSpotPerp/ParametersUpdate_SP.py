...
if __name__ == "__main__":
    ...
    manager.update_bot_params("MOODENG", notional_per_trade=150, ma=10, max_notional=78000, default_max_notional=78000, std_coeff=1, min_width=0.065)
    manager.update_bot_params("MYRO", notional_per_trade=150, ma=10, max_notional=60000, default_max_notional=60000, std_coeff=1, min_width=0.065)
    manager.update_bot_params("XRP", notional_per_trade=200, ma=10, max_notional=500, default_max_notional=500, std_coeff=1, min_width=0.065)
