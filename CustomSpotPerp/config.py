...
AZURE_SQL_CONNECTION_STRING = f"Driver={{ODBC Driver 17 for SQL Server}};Server=tcp:{AZURE_SQL_SERVER},1433;Database={AZURE_SQL_DATABASE};Uid={AZURE_SQL_USERNAME};Pwd={AZURE_SQL_PASSWORD};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
...
LOG_FILENAME = os.path.join(LOG_DIRECTORY, f"trading_bot_spot_{datetime.now().strftime('%Y%m%d')}.log")
