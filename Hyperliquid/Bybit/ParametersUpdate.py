...
if __name__ == "__main__":
    ...
    # Spot Perps
    manager.update_bot_params("LINK", notional_per_trade=250, ma=10, max_notional=80000, default_max_notional=80000, std_coeff=1, min_width=0.065)
    manager.update_bot_params("GOAT", notional_per_trade=250, ma=10, max_notional=95000, default_max_notional=95000, std_coeff=1, min_width=0.065)
    manager.update_bot_params("CHILLGUY", notional_per_trade=250, ma=10, max_notional=95000, default_max_notional=95000, std_coeff=1, min_width=0.065)
