...
if __name__ == "__main__":
    ...
    # Perp Perps
    # manager.update_bot_params("NEIRO", notional_per_trade=200, ma=10, max_notional=500, default_max_notional=500, std_coeff=1, min_width=0.065)
    # manager.update_bot_params("GOAT", notional_per_trade=25, ma=10, max_notional=500, default_max_notional=500, std_coeff=1, min_width=0.065)
    # manager.update_bot_params("GLM", notional_per_trade=25, ma=10, max_notional=500, default_max_notional=500, std_coeff=1, min_width=0.065)
    # manager.update_bot_params("MOODENG", notional_per_trade=25, ma=10, max_notional=500, default_max_notional=500, std_coeff=1, min_width=0.065)
    ...
    # manager.update_bot_params("MYRO", notional_per_trade=10, ma=10, max_notional=500, default_max_notional=60000, std_coeff=1, min_width=0.065)
    # manager.update_bot_params("BTC", notional_per_trade=10, ma=10, max_notional=500, default_max_notional=60000, std_coeff=1, min_width=0.065)
    # manager.update_bot_params("ETH", notional_per_trade=10, ma=10, max_notional=500, default_max_notional=60000, std_coeff=1, min_width=0.065)
    # manager.update_bot_params('MASK', notional_per_trade=10, ma=10, max_notional=30, default_max_notional=30, std_coeff=1, min_width=0.065)

    # Delete parameters
    # manager.delete_bot_params("FTM")
    # manager.delete_bot_params("PEPE")
    # manager.delete_bot_params("ARB")
    # manager.delete_bot_params('BTC')
    # manager.delete_bot_params('ETH')
