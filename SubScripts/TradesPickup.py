...
def run_trading_bot(start_time, end_time, symbol):
    ...
    okx_trades = fetch_usdt_perp_trades(okx, 'okx', start_time, end_time, symbol)
...
def main():
    start_datetime = datetime(2024, 8, 30, 15, 0, 0)
    end_datetime = datetime(2024, 8, 30, 21, 0, 0)
    # run_trading_bot(start_datetime, end_datetime, 'RDNT')
    ...
    while current_start < end_datetime:
        ...
        run_trading_bot(current_start, current_end, 'RDNT')
