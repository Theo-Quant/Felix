...
class CSVLogger:
    ...
    def create_new_file(self):
        ...
        filename = os.path.join(onedrive_path, f"bot_{self.bot_id}Manual_{timestamp}_V3.5.csv")
...
class TradingBot:
    ...
    async def main(self):
        ...
        while True:
            if abs(self.get_current_position_size()) < 500:
...
bot_configs = [
    {'symbol': 'AGLD', 'notional_per_trade': 250, 'bot_id': 'AGLD', 'max_notional': 100, 'spreadThreshold': 0.12, 'side': 'buy'}
]
