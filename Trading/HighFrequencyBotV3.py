...
class TradingBot:
    ...
    def get_trend_data(self, coin, fr_adjustment_factor):
        ...
        if coin_data['buy_spread_ma_M'] is None:
            config.send_telegram_message(
                f"Trend Redis Upload Azure is malfunctioning for {self.bot_id}... please check High Frequency Bot",
