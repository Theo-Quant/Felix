...
OKX_API_KEY_HYPERLIQUIDSUB = os.getenv('OKX_API_KEY_HYPERLIQUIDSUB', '')
OKX_SECRET_KEY_HYPERLIQUIDSUB = os.getenv('OKX_SECRET_KEY_HYPERLIQUIDSUB', '')
OKX_PASSPHRASE_HYPERLIQUIDSUB = os.getenv('OKX_PASSPHRASE_HYPERLIQUIDSUB', '')

BYBIT_API_KEY_HYPERLIQUIDSUB = os.getenv('BYBIT_API_KEY_HYPERLIQUIDSUB', '')
BYBIT_SECRET_KEY_HYPERLIQUIDSUB = os.getenv('BYBIT_SECRET_KEY_HYPERLIQUIDSUB', '')
...
HYPERLIQUID_SUB_HYPEArb = os.getenv('HYPERLIQUID_SUB_HYPEArb', '')
HYPERLIQUID_MAIN = os.getenv('HYPERLIQUID_MAIN', '')
